<%@ Page Title="" Language="C#" MasterPageFile="~/demo1/Main.Master" AutoEventWireup="true" CodeBehind="BorrowBackMangerPage.aspx.cs" Inherits="LsLibraryMS.Web.demo1.BorrowBackMangerPage" %>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server">
                        ...
                        <ItemTemplate>
                            ...
                            <tr onmouseover="Color=this.style.backgroundColor;this.style.backgroundColor='lightgray'"
                                ...
                                <td>
                                    <asp:CheckBox ID="systemSet" runat="server" Checked='<%#Eval("isReturn")%>' />
                                </td>
                                <td class="btright">
            ...
            <div class="col-sm-9 col-md-6 col-lg-3 top5em">
                ...
                <div class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <label for="disabledselect" class="col-sm-6 control-label">图书编号:</label>
                        <div class="col-sm-6" style="margin: 10px 0;">
